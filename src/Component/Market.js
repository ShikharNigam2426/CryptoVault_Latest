    ...
    return (
        <div className="container-fluid Market-Section py-5">
            <div className="container d-flex flex-column">
                ...
                <h2 className="market-heading white">Current Market</h2>

                <div className="market-params row white my-2">
                ...
                {coinData.map((data, index) => (
                    <div className="row white Market-Data my-3" key={index}>
                        <div className="col-3 d-flex flex-row">
                            <img className="coin-img mr-3" src={data.image} style={{ width: '3vmax' }} alt="" />
